...
export interface ApiChatChat extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    knowledge: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::chat.chat'> &
      Schema.Attribute.Private;
    message_count: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    messages: Schema.Attribute.Relation<'oneToMany', 'api::message.message'>;
    metadata: Schema.Attribute.JSON;
    model_name: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'gpt-3.5-turbo'>;
    model_provider: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'openai'>;
    publishedAt: Schema.Attribute.DateTime;
    rag_enabled: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
...
export interface ApiWorkspaceWorkspace extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Workspace configuration and branding';
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    verification_documents: Schema.Attribute.JSON;
